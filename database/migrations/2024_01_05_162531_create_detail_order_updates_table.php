...
class CreateDetailOrderUpdatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detail_order_updates', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('detail_order_updates');
    }
}
