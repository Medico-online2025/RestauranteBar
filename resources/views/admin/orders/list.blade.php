            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="card-title mb-0">
                        <h5 class="card-title mb-0">Gesti&oacute;n de Pedidos</h5>
                    </div>
                    <a href="{{ route('admin.create_order') }}" class="dt-button create-new btn btn-primary waves-effect waves-light">
...
@endsection
@section('scripts')
    @include('admin.orders.js-datatable')
