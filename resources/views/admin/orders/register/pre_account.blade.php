...
<body>
    <div class="cabecera">
        <p style="font-size: 15px; font-weight: bold; margin-bottom: 0; margin-top: 10px;">PRE CUENTA</p>
    ...
    <div class="informacion">
        <p style="font-size: 10px; margin-top:10px; margin-bottom: 0;">{{ $order->mesa }}</p>
        <p style="font-size: 10px; margin-top:0; margin-bottom: 0;">MESERO: {{ mb_strtoupper($order->mesero) }}</p>
        <p style="font-size: 11px; margin-top:0; font-weight: bold; margin-bottom: 0;">Fecha: {{ date('d-m-Y', strtotime($order->fecha)) }} Hora: {{ $order->hora }}</p>
    </div>
        ...
        <table style="border-top: 1px solid #c2c2c2;" width="100%">
            <thead style="border-bottom: 1px solid #c2c2c2" style="width: 100%">
                <tr>
                    ...
                    <th style="font-size: 12px; text-align: right;">Descripci&oacute;n</th>
                    <th style="font-size: 12px; text-align: right;" width="20%">Importe</th>
                </tr>
            </thead>
