    ...
    $('body').on('click', '.btn-detail', function()
    {
        ...
        $.ajax({
            ...
            success     : function(r){
                ...
                close_block('#layout-content');
                $('#form_edit input[name="id"]').val(r.table.id);
                $('#form_edit input[name="descripcion"]').val(r.table.descripcion);
                $(`#form_edit select[name="idsala"] option[value="${r.table.idsala}"]`).prop('selected', true);
