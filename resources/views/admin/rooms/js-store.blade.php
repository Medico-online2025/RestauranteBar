    ...
    $('body').on('click', '.btn-detail', function()
    {
        ...
        $.ajax({
            ...
            success     : function(r){
                ...
                close_block('#layout-content');
                $('#form_edit input[name="id"]').val(r.room.id);
                $('#form_edit input[name="descripcion"]').val(r.room.descripcion);
