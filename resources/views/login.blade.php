<!DOCTYPE html>
<html lang="es" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="assets/"
        ...
        <div class="authentication-inner row">
            ...
            <div class="d-none d-lg-flex col-lg-7 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    <img src="{{ asset('assets/img/illustrations/login-v2.svg') }}" alt="auth-login-cover"
                        class="img-fluid my-5 auth-illustration" data-app-light-img="illustrations/login-v2.svg" />
                </div>
            </div>
            <!-- /Left Text -->
                    ...
                    <form class="mb-3" action="{{ route('login.login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="user" name="user"
                                placeholder="Introduce tu nombre de usuario" autofocus autocomplete="off" />
                            @if (session('message'))
                                <div class="invalid-login">{{ session('message') }}</div>
                            @endif
                        </div>
